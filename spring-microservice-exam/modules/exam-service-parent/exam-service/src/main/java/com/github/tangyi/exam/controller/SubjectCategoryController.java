...
public class SubjectCategoryController extends BaseController {
     ...
     */
    @ResponseBody
    @PostMapping(value = "categoriesList")
    @ApiOperation(value = "获取平级分类列表")
    public List<CategoriesListVO> menusList(@RequestBody CategoriesListDTO categoriesListDTO) {
        return categoryService.menusList(categoriesListDTO);
    }
     ...
     */
    @ResponseBody
    @PostMapping(value = "questionBankChart")
    @ApiOperation(value = "获取各题库选题占比饼图")
